...
class GNQS:
    ...
    def gen_loss_fn(self, discriminator, params, noise):  # , batch_size, seed_seq):
        ...
        ####################
        # THE BELLOW DOES NOT WORK BECAUSE OF THE LOGP DATATYPE AFTER TRACER
        # on top of that there is a deeper problem of the generations being a stochastic process.
        # batch_gen = self.one_vmc_sample(params, batch_size, seed_seq) # either this or the noise to be implemented later
        ####################
        batch_gen = self.generate_int(noise, params)
...
class ANQS:
    def __init__(self, gen, disc, truth="gaussian"):
        self.gen = gen
        self.disc = disc
        self.truth = truth
    ...
    def train(self, max_iter, batch_size, discriminator_updates, **kwargs):
        ...
        dim = self.gen._dim
        # seed_seq = generate_seed_sequence(self.gen._seed, 1)[0]
